# Script: Run eigen decompositon of kernel matrix for various kernel hyperparameter settings on the right hemisphere.
...
mask = as.numeric(unlist(fread(paste0(path, 'mask/idx_right.csv'))[,2]))
