...
path_results_BR =  sprintf("%s/N%s_L%s_phi%s_nu%s/dataset%s/BR/", path_core, n_train, L, phi, nu, dataset)
dir.create(file.path(path_results_BR), showWarnings = FALSE)

path_results_LASSO =  sprintf("%s/N%s_L%s_phi%s_nu%s/dataset%s/Ridge_LASSO/", path_core, n_train, L, phi, nu, dataset)
...
path_results_RTGP_VI =  sprintf("%s/N%s_L%s_phi%s_nu%s/dataset%s/RTGP_VI/", path_core, n_train, L, phi, nu, dataset)
